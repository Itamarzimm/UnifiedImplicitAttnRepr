...
def get_args_parser():
    ...
    parser.add_argument('--exit_after_1_batch', action='store_true')

    parser.add_argument('--computeMamba', default='standard', choices=['Standard', 'S6HiddenMat', 'MambaHiddenMat'],
                        type=str, help='TBD')

    parser.add_argument('--attnmatrices_path', default=None, type=str)

    parser.add_argument('--attnvector_path', default=None, type=str)

    parser.add_argument('--old_attention', action='store_true')

    parser.add_argument('--compute_attn_gradients', action='store_true')

    parser.add_argument('--diff_maps', action='store_true')
